...
class OfficeMachines(StoreMashines):
    def __init__(self, name='', price=0, quantity=0, number_of_lists=0, *args):
        super().__init__(name, price, quantity, number_of_lists, *args)
